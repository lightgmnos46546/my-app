...
const newTable = `      <div className="table-container">
...
// Delete lines 5416-5450 (which corresponds to 1-indexed 5417-5451)
lines.splice(5416, 35, newTable);

fs.writeFileSync('src/squadron-dashboard.tsx', lines.join('\n'));
console.log('Successfully spliced table.');
